<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="OnlineCakeShop.User.Registration" %>
    ...
    ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
       ...
       &nbsp;
        &nbsp;
          ...
          <div class="col-lg-6">
    <div class="btn-box">
        <asp:Button ID="btnRegister" runat="server" Text="Register" CssClass=" btn btn-dark rounded-pill pl-4 pr-4 text-white" 
