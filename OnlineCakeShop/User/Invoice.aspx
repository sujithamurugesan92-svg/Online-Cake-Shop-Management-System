<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="OnlineCakeShop.User.Invoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="text-center mb-5">
            <asp:LinkButton ID="lbDownloadInvoice" runat="server" CssClass="btn btn-warning" OnClick="lbDownloadInvoice_Click" >
