...
namespace OnlineCakeShop.User
{
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        void ExportToPdf(DataTable dtblTable, String strPdfPath, string strHeader)
        {
            ...
            prgAuthor.Add(new Chunk("Order From : Online Cake Shop", fntAuthor));
        ...
        //    Paragraph p = new Paragraph(new Chunk(new iTextSharp.text.pdf.draw.LineSeparator(0.0F, 100.0F, Color.BLACK, Element.ALIGN_LEFT, 0.0F)));
        //    document.Add(p);
